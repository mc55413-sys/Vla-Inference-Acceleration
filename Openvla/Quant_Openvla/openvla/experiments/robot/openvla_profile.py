...
def build_arg_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument("--save_csv", type=str, default="out/openvla_profile_summary.csv")
    parser.add_argument("--save_json", type=str, default="out/openvla_profile_raw.json")
